...
// Includes from lpc2106.h  don't use these later...
...
#define EE_ADDR_L		0x0001C000		//Must match the EE_SEC_L Flash sector start address
#define EE_ADDR_H		0x0001DFFF	 	//Must match the EE_SEC_H Flash sector end address
...
#define EE_START_MASK	0xFFFFFE00
#define EE_BUFFER_MASK	0x000001F0
